...
#ifndef SBG4PSSphereSurfaceFlux_h
#define SBG4PSSphereSurfaceFlux_h 1
...
class SBG4PSSphereSurfaceFlux : public G4VPrimitiveScorer
{
 public:
  SBG4PSSphereSurfaceFlux(G4String name, G4int direction, G4int depth = 0);
  SBG4PSSphereSurfaceFlux(G4String name, G4int direction, const G4String& unit,
                        G4int depth = 0);
  ~SBG4PSSphereSurfaceFlux() override = default;
