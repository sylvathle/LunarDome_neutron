...
// ********************************************************************
//
// SBG4SPSEneDistribution class implementation
//
...
SBG4SPSEneDistribution::SBG4SPSEneDistribution()
{
  G4MUTEXINIT(mutex);
...
void SBG4SPSEneDistribution::SetEnergyDisType(const G4String& DisType)
{
  G4AutoLock l(&mutex);
...
const G4String& SBG4SPSEneDistribution::GetEnergyDisType()
{
  G4AutoLock l(&mutex);
  return EnergyDisType;
}

void SBG4SPSEneDistribution::SetEmin(G4double emi)
{
  G4AutoLock l(&mutex);
  Emin = emi;
...
G4double SBG4SPSEneDistribution::GetEmin() const
{
  return threadLocalData.Get().Emin;
}

G4double SBG4SPSEneDistribution::GetArbEmin()
{
  G4AutoLock l(&mutex);
  return ArbEmin;
}

G4double SBG4SPSEneDistribution::GetArbEmax()
{
  G4AutoLock l(&mutex);
  return ArbEmax;
}

void SBG4SPSEneDistribution::SetEmax(G4double ema)
{
  G4AutoLock l(&mutex);
  Emax = ema;
...
G4double SBG4SPSEneDistribution::GetEmax() const
{
  return threadLocalData.Get().Emax;
}

void SBG4SPSEneDistribution::SetMonoEnergy(G4double menergy)
{
  G4AutoLock l(&mutex);
  MonoEnergy = menergy;
}

void SBG4SPSEneDistribution::SetBeamSigmaInE(G4double e)
{
  G4AutoLock l(&mutex);
  SE = e;
}
void SBG4SPSEneDistribution::SetAlpha(G4double alp)
{
  G4AutoLock l(&mutex);
  alpha = alp;
...
void SBG4SPSEneDistribution::SetBiasAlpha(G4double alp)
{
  G4AutoLock l(&mutex);
  biasalpha = alp;
  Biased = true;
...
void SBG4SPSEneDistribution::SetTemp(G4double tem)
{
  G4AutoLock l(&mutex);
  Temp = tem;
}

void SBG4SPSEneDistribution::SetEzero(G4double eze)
{
  G4AutoLock l(&mutex);
  Ezero = eze;
...
void SBG4SPSEneDistribution::SetGradient(G4double gr)
{
  G4AutoLock l(&mutex);
  grad = gr;
...
void SBG4SPSEneDistribution::SetInterCept(G4double c)
{
  G4AutoLock l(&mutex);
  cept = c;
...
const G4String& SBG4SPSEneDistribution::GetIntType()
{
  G4AutoLock l(&mutex);
  return IntType;
}

void SBG4SPSEneDistribution::SetBiasRndm(G4SPSRandomGenerator* a)
{
  G4AutoLock l(&mutex);
  eneRndm = a;
}

void SBG4SPSEneDistribution::SetVerbosity(G4int a)
{
  G4AutoLock l(&mutex);
  verbosityLevel = a;
}

G4double SBG4SPSEneDistribution::GetWeight() const
{
  return threadLocalData.Get().weight;
}

G4double SBG4SPSEneDistribution::GetMonoEnergy()
{
  G4AutoLock l(&mutex);
  return MonoEnergy;
}

G4double SBG4SPSEneDistribution::GetSE()
{
  G4AutoLock l(&mutex);
  return SE;
}

G4double SBG4SPSEneDistribution::Getalpha() const
{
  return threadLocalData.Get().alpha;
}

G4double SBG4SPSEneDistribution::GetEzero() const
{
  return threadLocalData.Get().Ezero;
}

G4double SBG4SPSEneDistribution::GetTemp()
{
  G4AutoLock l(&mutex);
  return Temp;
}

G4double SBG4SPSEneDistribution::Getgrad() const
{
  return threadLocalData.Get().grad;
}

G4double SBG4SPSEneDistribution::Getcept() const
{
  return threadLocalData.Get().cept;
}

G4PhysicsFreeVector SBG4SPSEneDistribution::GetUserDefinedEnergyHisto()
{
  G4AutoLock l(&mutex);
  return UDefEnergyH;
}

G4PhysicsFreeVector SBG4SPSEneDistribution::GetArbEnergyHisto()
{
  G4AutoLock l(&mutex);
  return ArbEnergyH;
}

void SBG4SPSEneDistribution::UserEnergyHisto(const G4ThreeVector& input)
{
  G4AutoLock l(&mutex);
...
void SBG4SPSEneDistribution::ArbEnergyHisto(const G4ThreeVector& input)
{
  G4AutoLock l(&mutex);
  G4double ehi = input.x(),
           val = input.y();
...
void SBG4SPSEneDistribution::ArbEnergyHistoFile(const G4String& filename)
{
  G4AutoLock l(&mutex);
  std::ifstream infile(filename, std::ios::in);
  if (!infile)
  {
    G4Exception("SBG4SPSEneDistribution::ArbEnergyHistoFile", "Event0301",
...
void SBG4SPSEneDistribution::EpnEnergyHisto(const G4ThreeVector& input)
{
  G4AutoLock l(&mutex);
  G4double ehi = input.x(),
           val = input.y();
...
void SBG4SPSEneDistribution::Calculate()
{
  G4AutoLock l(&mutex);
...
void SBG4SPSEneDistribution::BBInitHists()  // MT: Lock in caller
{
...
void SBG4SPSEneDistribution::CPInitHists()  // MT: Lock in caller
{
...
void SBG4SPSEneDistribution::CalculateCdgSpectrum()  // MT: Lock in caller
{
...
void SBG4SPSEneDistribution::CalculateBbodySpectrum()  // MT: Lock in caller
{
...
void SBG4SPSEneDistribution::CalculateCPowSpectrum()  // MT: Lock in caller
{
...
void SBG4SPSEneDistribution::InputEnergySpectra(G4bool value)
{
  G4AutoLock l(&mutex);
...
void SBG4SPSEneDistribution::InputDifferentialSpectra(G4bool value)
{
  G4AutoLock l(&mutex);
...
void SBG4SPSEneDistribution::ArbInterpolate(const G4String& IType)
{
  G4AutoLock l(&mutex);
...
void SBG4SPSEneDistribution::LinearInterpolation()  // MT: Lock in caller
{
  ...
  if (!EnergySpec)
  {
    ...
    if (pdef == nullptr)
    {
      G4Exception("SBG4SPSEneDistribution::LinearInterpolation",
...
void SBG4SPSEneDistribution::LogInterpolation()  // MT: Lock in caller
{
  ...
  if (!EnergySpec)
  {
    ...
    if (pdef == nullptr)
    {
      G4Exception("SBG4SPSEneDistribution::LogInterpolation",
                  "Event0302", FatalException,
                  "Error: particle not defined");
    }
    else
...
void SBG4SPSEneDistribution::ExpInterpolation()  // MT: Lock in caller
{
  ...
  if (!EnergySpec)
  {
    ...
    if (pdef == nullptr)
    {
      G4Exception("SBG4SPSEneDistribution::ExpInterpolation",
                  "Event0302", FatalException,
                  "Error: particle not defined");
    }
    else
...
void SBG4SPSEneDistribution::SplineInterpolation()  // MT: Lock in caller
{
  ...
  if (!EnergySpec)
  {
    ...
    if (pdef == nullptr)
    {
      G4Exception("SBG4SPSEneDistribution::SplineInterpolation",
                  "Event0302", FatalException,
                  "Error: particle not defined");
    }
    else
    ...
    for (count = 0; count < 101; ++count)
    {
      ...
      { 
        ...
        ED << "Warning: G4DataInterpolation returns value < 0  " << prob[count]
           << " " << ei[count] << G4endl;
        G4Exception("SBG4SPSEneDistribution::SplineInterpolation", "Event0303",
                    FatalException, ED);
      }
      area += prob[count]*de;
    }
...
void SBG4SPSEneDistribution::GenerateMonoEnergetic()
{
...
void SBG4SPSEneDistribution::GenerateGaussEnergies()
{
...
void SBG4SPSEneDistribution::GenerateLinearEnergies(G4bool bArb = false)
{
...
void SBG4SPSEneDistribution::GeneratePowEnergies(G4bool bArb = false)
{
...
void SBG4SPSEneDistribution::GenerateCPowEnergies()
{
...
void SBG4SPSEneDistribution::GenerateBiasPowEnergies()
{
...
void SBG4SPSEneDistribution::GenerateExpEnergies(G4bool bArb = false)
{
...
void SBG4SPSEneDistribution::GenerateBremEnergies()
{
  // Method to generate particle energies distributed according
  ...
  if (expmax == 0.)
  {
    G4Exception("SBG4SPSEneDistribution::GenerateBremEnergies",
                "Event0302", FatalException,
...
void SBG4SPSEneDistribution::GenerateBbodyEnergies()
{
...
void SBG4SPSEneDistribution::GenerateCdgEnergies()
{
...
void SBG4SPSEneDistribution::GenUserHistEnergies()
{
  ...
  if (!IPDFEnergyExist)
  {
    ...
    {
      G4Exception("SBG4SPSEneDistribution::GenUserHistEnergies",
                  "Event0302", FatalException,
...
G4double SBG4SPSEneDistribution::GetArbEneWeight(G4double ene)
{
...
void SBG4SPSEneDistribution::GenArbPointEnergies()
{
  if (verbosityLevel > 0)
  {
  ...
  {
    G4Exception("SBG4SPSEneDistribution::GenArbPointEnergies", "Event0302",
                FatalException, "Error: IntType unknown type");
  }
}

void SBG4SPSEneDistribution::GenEpnHistEnergies()
{
...
void SBG4SPSEneDistribution::ConvertEPNToEnergy()  // MT: lock in caller
{
  ...
  else
  {
    ...
    if (maxcount > 1024)
    {
      G4Exception("SBG4SPSEneDistribution::ConvertEPNToEnergy()",
                  "gps001", JustWarning,
...
void SBG4SPSEneDistribution::ReSetHist(const G4String& atype)
{
  G4AutoLock l(&mutex);
  if (atype == "energy")
  {
...
G4double SBG4SPSEneDistribution::GenerateOne(G4ParticleDefinition* a)
{
  ...
  if((EnergyDisType == "Mono") && ((MonoEnergy>Emax)||(MonoEnergy<Emin)))
  {
    ...
    G4Exception("SBG4SPSEneDistribution::GenerateOne()",
...
G4double SBG4SPSEneDistribution::GetProbability(G4double ene)
{
  G4double prob = 1.;
  ...
  else if (EnergyDisType == "Arb")
  {
    ...
    if (prob <= 0.)
    {
      G4cout << " Warning:SBG4SPSEneDistribution::GetProbability: prob<= 0. "
             << prob << " " << ene << G4endl;
      prob = 1e-30;
    }
  }
